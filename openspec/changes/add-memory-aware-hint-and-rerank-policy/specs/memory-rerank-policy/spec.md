...
The system SHALL provide a memory rerank policy that receives a bounded candidate memory set and returns selected memories ranked for a specified purpose.
